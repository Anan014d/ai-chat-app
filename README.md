...
A modern AI-powered chat application built with **Stream Chat**, **GitHub Models**, and **web search capabilities**. This full-stack application provides an intelligent writing assistant that can help with content creation, research, and real-time collaboration.

## 🚀 Features

- **Real-time Chat**: Powered by [GetStream.io](https://getstream.io) for seamless messaging
- **AI Writing Assistant**: GitHub Models (GPT-family) integration for intelligent content generation
...
- **GitHub Models** inference endpoint for AI responses
...
- GitHub account with a Personal Access Token (PAT) for the Models inference endpoint
...
# GitHub Personal Access Token (PAT) for Models inference
# Create a PAT in your GitHub account with the appropriate scopes. See: https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens
...
2. **Initialization**: GitHub Models assistant setup with web search capabilities
...
- **GitHub Models** - AI language model
- **Axios** - HTTP client
...
- Review GitHub Models and PAT documentation:
